...
public class DynamicDataSourceConfig {
     ...
     * 配置HikariCP连接池参数
     */
    private void configureHikariCP(HikariDataSource dataSource, String poolName) {
    ...
    public DataSource masterDataSource() {
        ...
        if (masterProperties != null) {
            ...
            // 配置HikariCP连接池
            configureHikariCP(dataSource, "CampusHikariCP-Master");
        }
    ...
    public DataSource slaveDataSource() {
        ...
        if (slaveProperties != null) {
            ...
            // 配置HikariCP连接池
            configureHikariCP(dataSource, "CampusHikariCP-Slave");
        }
